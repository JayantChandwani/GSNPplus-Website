...
<form action="" method="post">
    <label>Age Range: <input type="text" name="age_range" value="<?php echo htmlspecialchars($age_range); ?>" placeholder="e.g., 25-35"></label><br>
    <label>Marital Status: <input type="text" name="marital_status" value="<?php echo htmlspecialchars($marital_status); ?>" placeholder="e.g., Single"></label><br>
    <label>Education: <input type="text" name="education" value="<?php echo htmlspecialchars($education); ?>" placeholder="e.g., Bachelor’s"></label><br>
